...
By:  Riya Aggarwal and Vrinda Sharma
...
# ----- Wikipedia API Initialization ( Vrinda Sharma and Riya Aggarwal) -----
import wikipediaapi
wiki_wiki = wikipediaapi.Wikipedia('en')

# ----- OpenWeatherMap API Initialization ( Riya Aggarwal) -----
from pyowm import OWM
owm = OWM('YOUR_OWM_API_KEY')

# ----- ipstack Geolocation API Initialization ( Riya Aggarwal) -----
...
# ----- Figuring out how users might respond (Vrinda Sharma) -----
answer_A = ["A", "a", "A.", "a."]
answer_B = ["B", "b", "B.", "b."]
answer_C = ["C", "c", "C.", "c."]
yes = ["Y", "y", "Yes", "yes", "YES"]
...
# -- Return to Main Menu ( Riya Aggarwal) --
...
# ----- Retrieve Summary of Wikipedia Article ( Riya Aggarwal) -----
def wiki_article_validate(articlename):
    ...
    if page_py.exists() == True:
        ...
        )  # This line was done with assistance from Vrinda Sharma
        print(
...
# ---------- Retrieve Local Weather ( Riya Aggarwal with assistance from Vrinda Sharma) ----------
...
def weather():  # This function was done by Vrinda Sharma
...
def weather_chat_validate(x):
    ...
    elif x == "2":  # Done by Vrinda Sharma
        if __name__ == '__main__':
            weather()
    else:  # Done by  Riya Aggarwal
        return False
...
# ---------- Interactive Story ( Vrinda Sharma and Riya Aggarwal) ----------
"NOTE: Vrinda Sharma wrote and defined the options for the story, whereas  Riya Aggarwal wrote definitions to validate user input for the story."

# ----- Definitions for Interactive Story ( Vrinda Sharma and Riya Aggarwal) -----
...
print(
    "Hello, my name is Python Chatbot!\nI was created by \Vrinda Sharma and Riya Aggarwal."
)
time.sleep(1)
returnname()
instructions()
